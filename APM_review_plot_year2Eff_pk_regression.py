...
sns.regplot(x=year, y=eff_pk, ci=99, scatter_kws={"s": 20, "color": "blue", "alpha": 0}, line_kws={"color": "red", "linestyle": "--", "linewidth": 1})
...
plt.savefig('outputs/year2Eff_pk_regression.png', dpi=300, bbox_inches='tight')
